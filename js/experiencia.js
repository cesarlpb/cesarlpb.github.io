  ...
  es:[ 
    ...
    },
    {
      ...
      <ul>
        ...
        <li><strong>Enfoque:</strong> Tecnología financiera (fintech), plataforma de intercambio</li>
      </ul>`,
      "tags": ["Django", "Python", "Fintech", "Blockchain"]
    },
    {
      "empresa": "Fundación Esplai",
      "cargo": "Instructor de Python",
      "periodo": "Abril 2024 - Mayo 2024",
      "descripcion": `Enseñanza de desarrollo full-stack en Python y tecnologías web a estudiantes:
      <ul>
        <li><strong>Front-end:</strong> HTML, CSS, JavaScript, React</li>
        <li><strong>Back-end:</strong> Python, Django</li>
        <li><strong>Enfoque:</strong> Machine learning e IA con librerías de Python</li>
      </ul>`,
      "tags": ["Python", "HTML", "CSS", "JavaScript", "React", "Machine Learning", "IA", "Django"]
    },
    {
      "empresa": "Onets",
      "cargo": "Desarrollador Full-Stack Senior",
      "periodo": "Septiembre 2023 - Marzo 2024",
      "descripcion": `Desarrollo de software personalizado para empresas y clientes:
      <ul>
        <li><strong>Back-end:</strong> Django, Python</li>
        <li><strong>Front-end:</strong> Tecnologías modernas según las necesidades del cliente</li>
        <li><strong>Enfoque:</strong> Integración de herramientas y tecnologías en operaciones diarias</li>
      </ul>`,
      "tags": ["Django", "Python", "Desarrollo Full Stack", "Software Personalizado"]
    },
    {
  ...
  en:[
    ...
    },    
    {
      ...
      <ul>
        ...
        <li><strong>Other clouds:</strong>Vercel, Google Cloud, setup of some services in Azure</li>
        <li><strong>Testing & CI/CD:</strong> Pytest, GitHub Actions</li>
        <li><strong>Infrastructure:</strong> Terraform, K8s, Docker</li>
        <li><strong>Databases:</strong> Sqlite in development, MySQL or Postgresql in production</li>
      </ul>
      ...
      "tags": ["Python", "Django", "Flask", "SQLAlchemy", "PostgreSQL", "MySQL", "Sqlite", "AWS", "Pytest", "GitHub Actions", "Terraform", "Software Architecture", "Mentorship"]
    },    
    {
